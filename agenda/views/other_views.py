...
from agenda.models import EventMember, Event
from agenda.utils import Calendar
from agenda.forms import EventForm, AddMemberForm
from django.contrib.auth.mixins import LoginRequiredMixin
    ...
    def get(self, request, *args, **kwargs):
        ...
        for event in events:
            event_list.append(
                {   "id": event.id,
                    "title": event.title,
                    "start": event.start_time.strftime("%Y-%m-%dT%S:%M:%H"),
                    "end": event.end_time.strftime("%Y-%m-%dT%S:%M:%H"),
